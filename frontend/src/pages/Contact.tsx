...
const Contact = () => {
  ...
  return (
    <div className="flex-1 text-base-text pt-36 lg:p-48 px-2 text-balance font-base flex flex-col gap-4">
      <h1 className="text-2xl lg:text-4xl text-center font-semibold">
        {t("contact.title")} <span className="text-primary">TrackIt!</span>
      </h1>
      <p className="text-lg text-center lg:w-1/2 lg:mx-auto lg:text-xl">
        {t("contact.paragraph")}
      </p>
      ...
      <a
        className="mt-4 text-center flex justify-center items-center gap-2 bg-primary rounded-md p-4 text-primary-text mx-auto hover:bg-primary-darker active:scale-95 hover:scale-105 tansition-all duration-300 ease-in-out"
