...
const MenuBigScreen: React.FC<MenuBigScreenType> = ({ logout }) => {
  ...
  return (
    <div className="bg-base font-base text-base-text h-full flex flex-col justify-between items-center fixed left-0 w-[50px] hover:w-[220px]  transition-all duration-300 group rounded-r-md">
      {/* //*Back to home Link */}
      <Link
        to="/home"
